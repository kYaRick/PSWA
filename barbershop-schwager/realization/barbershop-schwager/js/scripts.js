//TODO: пофіксити баг з картою: крашем карти карти
//! до: 25.12.20
//TODO: зробити модалку для того, коли юзер не робить ніяких дій впродовж N хвилин, з запитанням: "Ви ще тут?" і закривати вкладку, якщо бездіяльність продовжується N+30 сек
//! до: 27.12.20
...
// Переключає фоточки в картці товару
