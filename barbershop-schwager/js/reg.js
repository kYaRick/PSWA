...
const patterns = {
  // "email": /^[A-Za-z]{1,}([A-Za-z0-9]{1,}|([\.|_]{1})?[A-Za-z0-9]{1,}){1,}\@{1}[A-Za-z0-9]{1}((([\-|_]{1})?[A-Za-z0-9]{1,}){1,})?((\.{1}([A-Za-z]{1,}\-?[A-Za-z]{1,}){1,6}){0,5})?\.{1}[A-Za-z]{2,6}$/,
  "email": /^[A-Za-z]{1,}([A-Za-z0-9]{1,}|([\.|_]{1})?[A-Za-z0-9]{1,}){1,}\@{1}[A-Za-z0-9]{1}((\-{1})?[A-Za-z0-9]{1,}){0,}(\.{1}([A-Za-z0-9]{1,}\-{1})?[A-Za-z0-9]{1,}){0,6}(\.{1}[A-Za-z0-9]{2,6})$/,
  ...
  if (countFalse === 0) {
    $("#checking_form").on("click", function () {
      ...
      document.getElementById("text").innerHTML =
        ...
        "Фото: " + document.getElementById("file_photo").value;
    });
